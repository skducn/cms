            ...
            <div class="content-wrapper">
                ...
                <div class="row page-tilte align-items-center">
                  <div class="col-md-auto">
                    ...
                    <h1 class="weight-300 h3 title">主题背景</h1>
                ...
                <footer class="footer">
                  <p class="text-muted m-0" style="font-family:'Microsoft Yahei';"><small class="float-right"> <span class="material-icons md-16 text-danger align-middle">favorite</span> by john.jin </small></p>
                </footer>
