...
rs8.Open "select * from tblGroup",conn,3,3
...
if request.form("sub")="sub" then
	...
	rs.close
	set rs = nothing 
	response.Redirect("bGroupAdd.html")
end if 
%>
...
<div class="content">
	...
	<div class="col-lg-6 ">
	<div class="card mb-4">
		<div class="card-header">新增群组</div>
		<div class="card-body">
		...
		<input type="text" name="groupName"   maxlength="7" class="form-control">
		</div>
		</div>
